	...
	<div class="page-info-section page-info">
		<div class="container">
			<div class="site-breadcrumb">
				<a href="/">Trang chủ</a> / 
				<span>{{$sanpham->typeproductname}}</span>
			</div>
	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
						<img class="product-big-img" src="{{asset('image/product/'.$sanpham->image)}}" alt="" width="561" height="575">
					</figure>
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							@foreach($productimage as $productimage)
								<div class="pt" data-imgbigurl="{{asset('image/product/'.$productimage->name)}} "><img src="{{asset('image/product/'.$productimage->name)}} " alt=""></div>
							@endforeach
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="product-content">
						<h2>{{$sanpham->name}}</h2>
						<div class="pc-meta">
							<h4 class="price">{{number_format($sanpham->promotion_price)}} ₫ </h4>
							@if ($sanpham -> loai == 'sale')
			...
			<div class="row">
				@foreach($recommand as $recommand)
				<div class="col-lg-3">
					<div class="product-item">
						<a href="{{route('chitietsanpham1',$recommand->name1)}}">
						<figure>
							<img src="{{asset('image/product/'.$recommand->image)}}" alt="" width="267" height="362">
							@if($recommand -> loai == 'new')
							<div class="bache">NEW</div>
							@elseif($recommand -> loai == 'sale')
						...
						<div class="product-info">
							<h6>{{$recommand->name}}</h6>
							@if($recommand -> loai == 'sale') <p>{{number_format($recommand->promotion_price)}} ₫ 
								<span> <del> {{number_format($recommand->unit_price)}} ₫</del></span></p>
							@else
							<p> {{number_format($recommand->unit_price)}} ₫ </p>
							@endif
							<!-- <a href="#" class="site-btn btn-line">ADD TO CART</a> -->
						</div>
					</div>
